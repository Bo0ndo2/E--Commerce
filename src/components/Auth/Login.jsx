            ...
            >
                ...
                <div>
                    ...
                    <input
                        ...
                        className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${formik.touched.email && formik.errors.email
                            ? 'border-red-300'
                            : 'border-gray-300'
                            }`}
                ...
                <div>
                    ...
                    <input
                        ...
                        onBlur={formik.handleBlur}
                        disabled={loginMutation.isPending}
                        className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${formik.touched.password && formik.errors.password
                            ? 'border-red-300'
                            : 'border-gray-300'
                            }`}
                        placeholder="••••••••"
