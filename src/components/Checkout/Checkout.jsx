                    ...
                    <div className="lg:col-span-2">
                        <form onSubmit={formik.handleSubmit} className="space-y-6">
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <input
                                            ...
                                            disabled={isPending}
                                            className={`w-full border rounded-lg px-4 py-2 ${formik.touched.fullName && formik.errors.fullName
                                                ? 'border-red-400'
                                                : 'border-gray-300'
                                                }`}
                                        />
                            ...
                            <button
                                type="submit"
                                disabled={isPending}
                                className="w-full bg-primary text-white py-4 rounded-lg font-semibold hover:bg-blue-600 transition disabled:bg-gray-400"
                            >
